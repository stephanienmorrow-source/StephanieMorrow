const TRANSLATIONS = {
  en: {
    ...
    'info-edu-p': 'B.A. (Hons.), Psychology<br>King\'s University College, Western University',
  ...
  fr: {
    ...
    'info-edu-p': 'B.A. (avec distinction), Psychologie<br>King\'s University College, Université Western',
    'info-contact-h': 'Contact',
